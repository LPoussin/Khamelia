...
class InscriptionsRepository extends ServiceEntityRepository
{
    ...
    public function findByParent($value)
    {
        return $this->createQueryBuilder('i')
            ->andWhere('i.id_eleve = :idElev')
            ->andWhere('i.id_pere = :idparent OR i.id_mere = :idparent OR i.id_tuteur = :idparent')
            ->setParameter('idElev', $value['id_eleve'])
            ->setParameter('idparent', $value['idparent'])
            ->getQuery()
            ->getResult();
    }
